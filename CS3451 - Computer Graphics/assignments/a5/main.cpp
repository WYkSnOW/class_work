...
public:
    ...
    void Create_Old_Object_Scene()
    {
        ...
        {
            //// initialize mesh
            auto mimikyu = Add_Obj_Mesh_Object("mimikyu.obj");
            mimikyu->name = "mimikyu"; //// Must set name for the object
            ...
            Matrix4f rotate_y;
            rotate_y << cos(180), 0, sin(180), 0,
                0, 1, 0, 0,
                -sin(180), 0, cos(180), 0,
                0, 0, 0, 1;
            t = t * rotate_y;

            mimikyu->Set_Model_Matrix(t);

            //// initialize material
            mimikyu->Set_Ka(Vector3f(0.1, 0.1, 0.1));
            mimikyu->Set_Kd(Vector3f(0.7, 0.7, 0.7));
            mimikyu->Set_Ks(Vector3f(0.5, 0.5, 0.5));
            mimikyu->Set_Shininess(30.);

            //// initialize texture
            Add_Textture_For_Mesh_Object(mimikyu, "mimikyu.jpg", TexType::Color);
            Add_Textture_For_Mesh_Object(mimikyu, "buliao.jpg", TexType::Normal);
        }

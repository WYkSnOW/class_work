...
class SE2:
    ...
    def transform_point(self, point: Point) -> Point:
        ...
        transformed_point_matrix = np.dot(self.T, point_matrix)
        new_x, new_y = transformed_point_matrix[0], transformed_point_matrix[1]
        ########## END STUDENT CODE ##########
    ...
    def inverse(self) -> 'SE2':
        ...
        new_x = float(inv_T[0, 2])
        new_y = float(inv_T[1, 2])
        new_h = math.atan2(inv_T[1, 0], inv_T[0, 0])
        ########## END STUDENT CODE ##########

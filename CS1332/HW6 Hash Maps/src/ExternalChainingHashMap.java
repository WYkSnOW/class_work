...
public class ExternalChainingHashMap<K, V> {
    ...
    public V put(K key, V value) {
        if (key == null || value == null) {
            throw new java.lang.IllegalArgumentException("key or value can not be null.");
        } else {
            ...
            ExternalChainingMapEntry<K, V> head = table[idx];
    ...
    public V remove(K key) {
        if (key == null) {
            throw new java.lang.IllegalArgumentException("Can not search if key is null.");
        }
        int idx = Math.abs(key.hashCode() % table.length);
        ...
        throw new java.util.NoSuchElementException("Ket is not in the map");
    }
    ...
    public V get(K key) {
        ...
        throw new java.util.NoSuchElementException("Can not search for a key that is not in the hashmap.");
    }
    ...
    public void resizeBackingTable(int length) {
        if (length < size) {
            throw new java.lang.IllegalArgumentException("Length can not be less than # of items in the hash map.");
        }
        ExternalChainingMapEntry<K, V>[] temp = new ExternalChainingMapEntry[length];
        for (ExternalChainingMapEntry<K, V> i : table) {
            if (i != null) {
                temp[Math.abs(i.getKey().hashCode() % table.length)] = i;
            }
        }
        table = temp;
    }
